...
package com.squareup.protos.packed_encoding
...
public class OuterMessage(
  @field:WireField(
    ...
    jsonName = "outerNumberBefore",
  )
  public val outer_number_before: Int? = null,
  @field:WireField(
    tag = 2,
    adapter = "com.squareup.protos.packed_encoding.EmbeddedMessage#ADAPTER",
    jsonName = "embeddedMessage",
  )
