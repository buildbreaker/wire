...
package com.squareup.protos.kotlin.oneof
...
public class Form(
  @field:WireField(
    tag = 1,
    adapter = "com.squareup.protos.kotlin.oneof.Form${'$'}ButtonElement#ADAPTER",
    jsonName = "buttonElement",
    oneofName = "choice",
  )
  public val button_element: ButtonElement? = null,
  @field:WireField(
    tag = 2,
    adapter = "com.squareup.protos.kotlin.oneof.Form${'$'}LocalImageElement#ADAPTER",
    jsonName = "localImageElement",
    oneofName = "choice",
  )
  public val local_image_element: LocalImageElement? = null,
  @field:WireField(
    tag = 3,
    adapter = "com.squareup.protos.kotlin.oneof.Form${'$'}RemoteImageElement#ADAPTER",
    jsonName = "remoteImageElement",
    oneofName = "choice",
  )
  public val remote_image_element: RemoteImageElement? = null,
  @field:WireField(
    tag = 4,
    adapter = "com.squareup.protos.kotlin.oneof.Form${'$'}MoneyElement#ADAPTER",
    jsonName = "moneyElement",
    oneofName = "choice",
  )
  public val money_element: MoneyElement? = null,
  @field:WireField(
    tag = 5,
    adapter = "com.squareup.protos.kotlin.oneof.Form${'$'}SpacerElement#ADAPTER",
    jsonName = "spacerElement",
    oneofName = "choice",
  )
  public val spacer_element: SpacerElement? = null,
  @field:WireField(
    tag = 6,
    adapter = "com.squareup.protos.kotlin.oneof.Form${'$'}TextElement#ADAPTER",
    jsonName = "textElement",
    oneofName = "choice",
  )
  public val text_element: TextElement? = null,
  @field:WireField(
    tag = 7,
    adapter = "com.squareup.protos.kotlin.oneof.Form${'$'}CustomizedCardElement#ADAPTER",
    jsonName = "customizedCardElement",
    oneofName = "choice",
  )
  public val customized_card_element: CustomizedCardElement? = null,
  @field:WireField(
    tag = 8,
    adapter = "com.squareup.protos.kotlin.oneof.Form${'$'}AddressElement#ADAPTER",
    jsonName = "addressElement",
    oneofName = "choice",
  )
  public val address_element: AddressElement? = null,
  @field:WireField(
    tag = 9,
    adapter = "com.squareup.protos.kotlin.oneof.Form${'$'}TextInputElement#ADAPTER",
    jsonName = "textInputElement",
    oneofName = "choice",
  )
  ...
  @field:WireField(
    tag = 10,
    adapter = "com.squareup.protos.kotlin.oneof.Form${'$'}OptionPickerElement#ADAPTER",
    jsonName = "optionPickerElement",
    oneofName = "choice",
  )
  public val option_picker_element: OptionPickerElement? = null,
  @field:WireField(
    tag = 11,
    adapter = "com.squareup.protos.kotlin.oneof.Form${'$'}DetailRowElement#ADAPTER",
    jsonName = "detailRowElement",
    oneofName = "choice",
  )
  public val detail_row_element: DetailRowElement? = null,
  @field:WireField(
    tag = 12,
    adapter = "com.squareup.protos.kotlin.oneof.Form${'$'}CurrencyConversionFlagsElement#ADAPTER",
    jsonName = "currencyConversionFlagsElement",
    oneofName = "choice",
  )
