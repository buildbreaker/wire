...
package com.squareup.protos.kotlin.redacted_test
...
public class RedactedChild(
  ...
  @field:WireField(
    tag = 2,
    adapter = "com.squareup.protos.kotlin.redacted_test.RedactedFields#ADAPTER",
  )
  public val b: RedactedFields? = null,
  @field:WireField(
    tag = 3,
    adapter = "com.squareup.protos.kotlin.redacted_test.NotRedacted#ADAPTER",
  )
