...
package com.squareup.protos.kotlin.alltypes
...
public class AllTypes(
  ...
  @field:WireField(
    tag = 16,
    adapter = "com.squareup.protos.kotlin.alltypes.AllTypes${'$'}NestedEnum#ADAPTER",
    jsonName = "optNestedEnum",
  )
  public val opt_nested_enum: NestedEnum? = null,
  @field:WireField(
    tag = 17,
    adapter = "com.squareup.protos.kotlin.alltypes.AllTypes${'$'}NestedMessage#ADAPTER",
    jsonName = "optNestedMessage",
  )
  ...
  public fun copy(
    ...
    unknownFields: ByteString = this.unknownFields,
      ...
      map_string_message, map_string_enum, unknownFields)
