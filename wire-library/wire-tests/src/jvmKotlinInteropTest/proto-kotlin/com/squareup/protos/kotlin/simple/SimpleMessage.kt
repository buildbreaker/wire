...
import com.squareup.protos.kotlin.foreign.ForeignEnum
...
public class SimpleMessage(
  ...
  @field:WireField(
    tag = 2,
    adapter = "com.squareup.protos.kotlin.simple.SimpleMessage${'$'}NestedMessage#ADAPTER",
    jsonName = "optionalNestedMsg",
  )
  ...
  @field:WireField(
    tag = 3,
    adapter = "com.squareup.protos.kotlin.simple.ExternalMessage#ADAPTER",
    jsonName = "optionalExternalMsg",
  )
  public val optional_external_msg: ExternalMessage? = null,
  @field:WireField(
    tag = 4,
    adapter = "com.squareup.protos.kotlin.simple.SimpleMessage${'$'}NestedEnum#ADAPTER",
  ...
  @field:WireField(
    tag = 7,
    adapter = "com.squareup.protos.kotlin.foreign.ForeignEnum#ADAPTER",
