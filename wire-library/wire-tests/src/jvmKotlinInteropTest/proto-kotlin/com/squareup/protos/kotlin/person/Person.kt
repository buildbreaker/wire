...
package com.squareup.protos.kotlin.person
...
public class Person(
  ...
  @field:WireField(
    tag = 4,
    adapter = "com.squareup.protos.kotlin.person.Person${'$'}PhoneNumber#ADAPTER",
  ...
  public class PhoneNumber(
    ...
    @field:WireField(
      tag = 2,
      adapter = "com.squareup.protos.kotlin.person.Person${'$'}PhoneType#ADAPTER",
    )
